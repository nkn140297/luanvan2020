                                    ...
                                    <table class="table table-striped table-bordered table-hover" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="even gradeC" align="center">
                                                ...
                                                <td>{{$hd->nguoi_laphd}}</td>
                                                <td>
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg" value="{{$hd->id_hopdong}}" id="hopdong"><i class="fa fa-eye"></i>
                                                        Xem
                                                    </button>
                                                    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog modal-lg modal-dialog-centered">
...
@section('script')
    <script>
        $(document).ready(function(){
            $("#hopdong").click(function(){
                var hopdong=$(this).val();
                alert(hopdong);
