                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form class="needs-validation" method="POST" action="{{url('private/ykien/sua/'.$ykien->id_luuykien)}}"novalidate>
                                {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                                        ...
                                        @endif
                                        {{-- <label for="nop_minh_chung" class=" ">Nộp Minh Chứng (Hình Ảnh)</label>
                                        <input type="file" class="form-control" name="nop_minh_chung" accept="image/png, image/jpeg, image/jpg"> --}}
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
