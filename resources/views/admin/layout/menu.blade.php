                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-1-1" aria-controls="submenu-1-1">Thống kê</a>
                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            ...
                                            <div id="submenu-11" class="collapse submenu" style="">
                                                <ul class="nav flex-column">
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="pages/general.html">Đề xuất tăng lương</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="pages/carousel.html">Đề xuất khen thưởng</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="pages/listgroup.html">Đề xuất kỷ luật</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="pages/typography.html">Đề xuất tăng ca</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="pages/accordions.html">Đề xuất công tác</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" href="pages/accordions.html">Các ý kiến khác</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/tabs.html">Hợp đồng lao động</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/tabs.html">Lập hồ sơ nhân viên</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/tabs.html">Quyết định thôi việc</a>
                                        </li>
                                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-3" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/chart-sparkline.html">Chấm công</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/chart-gauge.html">Công việc</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/chart-c3.html">Thông tin cá nhân</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/chart-chartist.html">Thông tin gia đình</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/chart-charts.html">Hợp đồng</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/chart-morris.html">Bảo hiểm</a>
                                        </li>
                                        
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/chart-gauge.html">Lương tháng</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/chart-gauge.html">Thuế thu nhập cá nhân</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/chart-gauge.html">Lương</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/chart-gauge.html">Gửi ý kiến!</a>
                                        </li>
