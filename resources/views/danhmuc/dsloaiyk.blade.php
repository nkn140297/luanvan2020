                                ...
                                <table class="table table-striped table-bordered" id="data-tables">
                                    ...
                                    @foreach($loaiykien as $lyk) 
                                        <tr class="even gradeC" align="center">
                                            ...
                                            <td><a class="btn btn-outline-primary" href="{{url('private/loaiykien/sua/'.$lyk->id_ykien)}}">Sửa</a> <a class="btn btn-outline-danger" href="{{url('private/loaiykien/xoa/'.$lyk->id_ykien)}}">Xóa</a></td>
                                        </tr> 
                                    @endforeach
                                    </tbody>
                                </table>
